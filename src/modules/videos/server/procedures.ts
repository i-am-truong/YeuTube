...
import { eq, and, getTableColumns, inArray, isNotNull, or, lt, desc, ilike } from "drizzle-orm";
        ...
        getMany: baseProcedure.input(z.object({
                ...
                const data = await db
                    ...
                    .where(and(
                        ...
                        categoryId
                            ? eq(videos.categoryId, categoryId) : undefined,
                        cursor
                            ? or(
                                lt(videos.updatedAt, cursor.updatedAt),
                                and(
    ...
    getOne: baseProcedure
        ...
        .query(async ({ input, ctx }) => {
            ...
            const viewerReactions = db.$with("viewer_reactions").as(
                db.select({ videoId: videoReactions.videoId, type: videoReactions.type }).from(videoReactions).where(inArray(videoReactions.userId, userId ? [userId] : []))
            )
